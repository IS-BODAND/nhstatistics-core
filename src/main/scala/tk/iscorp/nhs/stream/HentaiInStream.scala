...
/**
  * Trait that defines methods to read in hentai doujins as [[tk.iscorp.nhs.data.Gallery]] instances
  */
trait HentaiInStream {
  ...
  /**
    ...
    *         If any of the IDs are invalid their returned doujin will be [[tk.iscorp.nhs.data.Gallery#dummy]]
    */
  @NotNull
