...
object GalleryDataSupplier {
  ...
  def no1(boolean: Boolean) =
    new Gallery(
      ...
      new DoujinshiHentai(138514),
      14,
      "2014-06-28T14:12:16.640420+00:00",
      1,
      9
    )
